...
public class TestSuite {
	...
	private static boolean testI_eme() {
		...
		if (!resultat.equals(attendu)) {
			testOK = false;
			System.out.println("On a demandé le 6ème élément de " + s + ".");
			System.out.println("Le résultat attendu est " + attendu);
			System.out.println("Votre méthode a renvoyé " + resultat);
		}
		resultat = s.iEme(12);
		...
		if (!resultat.equals(attendu)) {
			testOK = false;
			System.out.println("On a demandé le 12ème élément de " + s + ".");
			System.out.println("Le résultat attendu est " + attendu);
			System.out.println("Votre méthode a renvoyé " + resultat);
		}
		if (testOK) {
	...
	private static boolean testTronquee() {
		...
		if (sontDifferentes(sTronquee, sRenvoyee)) {
			testOK = false;
			System.out.println(
					"La suite " + s + " dont on tronque à partir du deuxième élément donne " + sTronquee);
			System.out.println("Attention, votre méthode a renvoyé la suite " + sRenvoyee);
		}
		...
		if (sontDifferentes(sTronquee, sRenvoyee)) {
			testOK = false;
			System.out.println(
					"La suite " + s + " dont on tronque à partir du troisième élément donne " + sTronquee);
			System.out.println("Attention, votre méthode a renvoyé la suite " + sRenvoyee);
		}
		sTronquee = new Suite();
